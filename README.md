...
SHARZO bridges the gap between the operating system and human intent. Through natural dialogue, SHARZO analyzes your screen, processes uploaded documents, and executes complex workflows, all housed within a completely raw, unadulterated Cyberpunk Hacker Terminal interface.
...
- 💻 **Retro Hacker Terminal UI** — A complete overhaul of the interface. SHARZO now features a pure OLED black background, piercing neon green phosphor text, and an animated ASCII-art hacker avatar synced perfectly to its voice.
...
```bash
git clone https://github.com/KAJUKATLIii/sharzo-assisatnt.git
cd sharzo-assisatnt
