...
def should_extract_memory(user_text: str, SHARZO_text: str, api_key: str = "") -> bool:
    try:
        from or_client import client

        combined = f"User: {user_text[:300]}\nSHARZO: {SHARZO_text[:1000]}"
...
def extract_memory(user_text: str, SHARZO_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client

        combined = f"User: {user_text[:600]}\nSHARZO: {SHARZO_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a SHARZO-like AI assistant')\n"
            ...
            f"- Extract from BOTH user and SHARZO turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"SHARZO-like AI assistant"}}}},\n'
