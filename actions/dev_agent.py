...
PROJECTS_DIR     = Path.home() / "Desktop" / "SharzoProjects"
MAX_FIX_ATTEMPTS = 5
...
class _GeminiModel:
    """Thin wrapper so call sites keep using model.generate_content(x)."""
    def __init__(self, model_name: str):
        from google import genai as _genai
        self._client = _genai.Client(api_key=_get_api_key())
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "sharzo_project")
